  ...
  void setup() {
    servo01.attach(11); servo02.attach(10); servo03.attach(9);servo04.attach(6); servo05.attach(5); // attaches the servo on pin 9 to the servo object
  }
  
  void loop() {
    val01 = analogRead(p0);            // reads the value of the potentiometer (value between 0 and 1023)
    val01 = map(val01, 0, 1023, 0, 90);     // scale it to use it with the servo (value between 0 and 180)
    ...
    val02 = map(val02, 0, 1023, 0, 90);     // scale it to use it with the servo (value between 0 and 180)
    ...
    val03 = map(val03, 0, 1023, 0, 90);     // scale it to use it with the servo (value between 0 and 180)
    ...
    val04 = map(val04, 0, 1023, 0, 90);     // scale it to use it with the servo (value between 0 and 180)
    ...
    val05 = map(val05, 0, 1023, 0, 90);     // scale it to use it with the servo (value between 0 and 180)
